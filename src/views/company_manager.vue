...
export default {
  ...
  data: () => ({
    ...
    columns: [
      ...
      {title: 'company_code', field: 'CompanyCode', thComp: 'th-i18n', sortable: true},
      {title: 'secondary_domain', field: 'SecondaryDomain', thComp: 'th-i18n'},
      {title: 'status', field: 'Status', sortable: true, thComp: 'th-i18n', tdComp: 'td-status'},
